...
public class ServerButton extends MouseAdapter {
    public Clip clip = null;
    public Volume vol = null;
    public ServerButton(Clip c,Volume v){
        clip = c;
        vol = v;
    }
    @Override
    public void mouseEntered(MouseEvent e) {
        ...
        if (source instanceof JLabel) {
            ...
            Point p = new Point();
            //调用JLabel的方法
            ImageIcon icon = new ImageIcon("./src/Assets/BServer.png");
            label.setIcon(icon);
    ...
    public void mouseExited(MouseEvent e) {
        ...
        if (source instanceof JLabel) {
            ...
            Point p = new Point();
            //调用JLabel的方法
            ImageIcon icon = new ImageIcon("./src/Assets/Server.png");
            label.setIcon(icon);
            label.setSize(icon.getIconWidth(),icon.getIconHeight());
            label.getLocation(p);
            label.setLocation(p.x+15,p.y +5);
