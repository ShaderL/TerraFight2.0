...
public class Button3ML extends MouseAdapter {
    public Clip clip = null;
    public Volume vol = null;
    public Button3ML(Clip c,Volume v){
        clip = c;
        vol = v;
    }
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        if (source instanceof JLabel) {
            ...
            Point p = new Point();
            //调用JLabel的方法
            ImageIcon icon = new ImageIcon("./src/Assets/BMenuBar3.png");
            label.setIcon(icon);
    ...
    public void mouseExited(MouseEvent e) {
        ...
        if (source instanceof JLabel) {
            ...
            Point p = new Point();
            //调用JLabel的方法
            ImageIcon icon = new ImageIcon("./src/Assets/MenuBar3.png");
            label.setIcon(icon);
            label.setSize(icon.getIconWidth(),icon.getIconHeight());
            label.getLocation(p);
            label.setLocation(p.x+15,p.y +5);
